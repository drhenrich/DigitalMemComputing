"""
Solar System DMM — Lagrange Point Discovery
Discovers all 5 Lagrange points for any two-body pair in the solar system
using the adaptive vector-memory Digital MemComputing Machine.
No solution coordinates are provided; the DMM reads local curvature Ω_yy
at each step to determine correction current vs. amplification.
"""
...
# ── Streamlit UI ───────────────────────────────────────────────────────────────
st.set_page_config(page_title="Solar System DMM", layout="wide", page_icon="🌌")
st.title("🌌 Solar System Lagrange Point Discovery via DMM")
st.markdown(
    r"""
