...
toward $\mathbb{I}$ supplies a safe default ($B_{yy}=1$) where the step is too small to
measure. Equivalently, $B$ follows a continuous leak $\dot B=-\lambda(B-\mathbb{I})$
...
$B=\mathbb{I}$, $s=-1$ (the safe descending state), and the Broyden
...
$\lambda$ & Broyden leak toward $\mathbb{I}$ & $2.0$\\
